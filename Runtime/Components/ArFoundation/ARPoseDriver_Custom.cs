...
{
    public class ARPoseDriver_Custom : MonoBehaviour
    {
        ...
        void PerformUpdate()
        {
            ...
            // FOR DEBUG
            // Debug.Log($"updating AR Position and Rotation: {updatedPose.position.Value}");
        ...
        static public NullablePose GetPoseData()
        {
